...
Shape mucadcpp_cylinder(double cx,double cy,double cz,double r,double h);
Shape mucadcpp_cone(double cx,double cy,double cz,double r1,double r2,double h);
Shape mucadcpp_torus(double cx,double cy,double cz,double R,double r);
Shape mucadcpp_arc(double x1,double y1,double x2,double y2,double x3,double y3);
...
Shape mucadcpp_sweep(Shape profile,double x0,double y0,double z0,
...
int mucadcpp_bounding_sphere(Shape s, double* x, double* y, double* z,
        double* r);
...
// 8 TopAbs_VERTEX   
// 9 TopAbs_SHAPE 
int mucadcpp_shape_type(Shape s); // enum: 0=WIRE,1=FACE,2=SHELL,3=SOLID,4=COMPOUND

/* ---- cleanup -------------------------------------------------------- */
void mucadcpp_free(Shape s);

/* ---- optional helpers ------------------------------------------------ */
Shape mucadcpp_clone(Shape s);
int mucadcpp_set_tolerance(double tol);
double mucadcpp_get_tolerance(void);
